function progressBar(canvas){
	...
	this.centerimage.src = "clouds.png";
	setTimeout(this.redraw(this.canvas, this.percent, this), 33);
...
function progressBarRedraw(canvas, percent, parent){
	...
	//Draw percent indicator in center
	...
	setTimeout(parent.redraw(parent.canvas, parent.percent, parent), 33);
	}	
...
function progressBarNewParticle(radians){
	...
	this.particles[this.particles.length] = new progressBarParticle(x, y, (.5 - Math.random()) * 2, (.5 - Math.random()) * 2, 10);
}
